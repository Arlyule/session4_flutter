import 'package:app_noticias/news_web_view.dart';
...
class _NewsPageState extends State<NewsPage> {
  ...
  Future<List<Article>> getNewsData() async {
    NewsAPI newsAPI = NewsAPI(apiKey: "dcb4e9514c334c579c38a51859a7ab84");
  ...
  searchAppBar() {
    return AppBar(
      backgroundColor: Color.fromARGB(255, 78, 22, 104),
      leading: IconButton(
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                ...
                categoryItems[index] == selectedCategory
                    ? Color.fromARGB(255, 78, 22, 104).withOpacity(0.5)
                    : Color.fromARGB(255, 78, 22, 104),
              )),
